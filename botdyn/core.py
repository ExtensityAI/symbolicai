...
from .functional import few_shot_func, search_func, crawler_func, userinput_func, execute_func, open_func, output_func, command_func, embed_func, vision_func, ocr_func, speech_func, imagerendering_func, setup_func
...
def few_shot(prompt: str,
    ...
    Args:
        ...
        **wrp_kwargs: Additional arguments as key-value pairs passed to the decorated function, which can later accessed in pre_processors and post_processors via the wrp_pramas['key'] dictionary.
...
def summarize(prompt: str = 'Summarize the content of the following text:\n', 
              constraints: List[Callable] = [], 
              default: Optional[object] = None, 
              pre_processor: Optional[List[PreProcessor]] = [TextMessagePreProcessor()],
...
def equals(context: str = 'contextually',
    ...
    Args:
        ...
        examples (List[str], optional): List of fuzzy examples showing how to compare objects in specified format. Defaults to FuzzyEquals().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def sufficient(query: str,
               ...
               default: bool = False,
               examples: List[str] = SufficientInformation(),
               constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): A list of example inputs used to train the model. Defaults to SufficientInformation().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def delitem(default: Optional[str] = None,
    ...
    Args:
        ...
        examples (List[str], optional): A list of strings from which the model can learn. Defaults to RemoveIndex().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def setitem(default: Optional[str] = None,
    ...
    Args:
        ...
        examples (List[str], optional): A list of examples that the model should be trained on. Defaults to SetIndex().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def getitem(default: Optional[str] = None,
    ...
    Args:
        ...
        examples (List[str], optional): A list of examples to be used for training. Defaults to Index().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def modify(changes: str,
    ...
    Args:
        ...
        examples (List[str], optional): List of possible modifications in specified format. Defaults to Modify().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def filtering(criteria: str,
    ...
    Args:
        ...
        examples (List[str], optional): List of filtered examples in specified format. Defaults to Filter().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def notify(subscriber: Dict[str, Callable],
           ...
           examples: List[str] = SemanticMapping(),
           constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): List of semantic mapping examples. Defaults to SemanticMapping().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def compare(default: bool = False,
            ...
            examples: List[str] = CompareValues(),
            constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): List of comparison examples. Defaults to CompareValues().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def convert(format: str,
    ...
    Args:
        ...
        examples (List[str], optional): List of format examples. Defaults to Format().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def analyze(query: str,
            exception: Exception,
            default: Optional[str] = None,
            prompt: str = "Analyse the error and propose a correction.\n",
            examples: List[str] = ExceptionMapping(),
            constraints: List[Callable] = [],
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        prompt (str, optional): The prompt describing the task. Defaults to 'Analyse the error and propose a correction.'.
        examples (List[str], optional): A list of example answers to the error. Defaults to ExceptionMapping().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def correct(context: str,
            ...
            examples: List[str] = ExecutionCorrection(),
            constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): A list of example answers to the error. Defaults to ExecutionCorrection().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def translate(language: str = 'English',
    ...
    Args:
        ...
        examples (List[str], optional): A list of example texts to be used as a reference. Defaults to [].
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def rank(default: Optional[object] = None,
    ...
    Args:
        ...
        examples (List[str], optional): A list of examples of ordered objects. Defaults to RankList().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def replace(prompt: str = "Replace text parts by string pattern.\n",
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None.
        examples (List[str], optional): A list of examples to be used to train the model. Defaults to ReplaceText().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def include(prompt: str = "Include information based on description.\n",
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples containing information to be included. Defaults to IncludeText().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
        pre_processor (List[PreProcessor], optional): A list of pre-processors to be applied to the input and shape the input to the model. Defaults to None.
        post_processor (List[PostProcessor], optional): A list of post-processors to be applied to the model output and before returning the result. Defaults to [StripPostProcessor()].
...
def combine(prompt: str = "Add the two data types in a logical way:\n",
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None.
        examples (List[str], optional): A list of examples to show how the data should be combined. Defaults to CombineText().
...
def template(template: str,
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples to train the model. Defaults to [].
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def negate(prompt: str = "Negate the following statement:\n",
           default: Optional[str] = None,
           examples: List[str] = NegateStatement(),
           constraints: List[Callable] = [],
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None.
        examples (List[str], optional): A list of example statements to be used for training. Defaults to NegateStatement().
        constraints (List[Callable], optional): A list of constraints applied to the model output to verify the output. Defaults to [].
...
def contains(default: bool = False,
             ...
             examples: List[str] = ContainsValue(),
             constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): Examples of strings to check if they contain the given string. Defaults to ContainsValue().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def isinstanceof(default: bool = False,
                 ...
                 examples: List[str] = IsInstanceOf(),
                 constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): A list of examples used to train the model. Defaults to IsInstanceOf().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def extract(prompt: str = "Extract a pattern from text:\n",
            default: Optional[str] = None,
            examples: List[str] = ExtractPattern(),
            constraints: List[Callable] = [],
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples of the pattern to be extracted. Defaults to ExtractPattern().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def expression(prompt: str = "Evaluate the symbolic expressions:\n",
               default: Optional[str] = None,
               examples: List[str] = SimpleSymbolicExpression(),
               constraints: List[Callable] = [],
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples used to train the model. Defaults to SimpleSymbolicExpression().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def logic(prompt: str = "Evaluate the logic expressions:\n",
          operator: str = 'and',
          default: Optional[str] = None,
          examples: List[str] = LogicExpression(),
          constraints: List[Callable] = [],
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): The list of examples to be tested. Defaults to LogicExpression().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
        pre_processor (List[PreProcessor], optional): A list of pre-processors to be applied to the input and shape the input to the model. Defaults to None.
        post_processor (List[PostProcessor], optional): A list of post-processors to be applied to the model output and before returning the result. Defaults to [StripPostProcessor()].
...
def invert(prompt: str = "Invert the logic of the content:\n",
           default: Optional[str] = None,
           examples: List[str] = InvertExpression(),
           constraints: List[Callable] = [],
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples used to train the model. Defaults to InvertExpression().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def simulate(prompt: str = "Simulate the following code:\n",
             default: Optional[str] = None,
             limit: int = None,
             examples: List[str] = SimulateCode(),
             constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): A list of example codes used to train the model. Defaults to SimulateCode().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def code(prompt: str = "Generate code that solves the following problems:\n",
         default: Optional[str] = None,
         limit: int = None,
         examples: List[str] = GenerateCode(),
         constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): A list of given examples of code. Defaults to GenerateCode().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def outline(prompt: str = "Outline only the essential content as a short list of bullets. Each bullet is in a new line:\n",
            ...
            limit: int = None,
            examples: List[str] = TextToOutline(),
            constraints: List[Callable] = [],
    ...
    Args:
        ...
        examples (List[str], optional): The list of examples provided. Defaults to TextToOutline().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
        pre_processor (List[PreProcessor], optional): A list of pre-processors to be applied to the input and shape the input to the model. Defaults to None.
...
def unique(prompt: str = "Create a short unique key that captures the essential topic from the following statements and does not collide with the list of keys:\n",
    ...
    Args:
        ...
        examples (List[str], optional): A list of example keys that the unique key should be based on. Defaults to UniqueKey().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def clean(prompt: str = "Clean up the text from special characters or escape sequences:\n",
    ...
    Args:
        ...
        examples (List[str], optional): A list of examples to be used to train the model. Defaults to [CleanText()].
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def compose(prompt: str = "Create a coherent text based on an outline:\n",
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples that help guide the model to solve the task. Defaults to [].
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def foreach(condition: str,
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples to be used by the model. Defaults to ForEach().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
        pre_processor (List[PreProcessor], optional): A list of pre-processors to be applied to the input and shape the input to the model. Defaults to None.
        post_processor (List[PostProcessor], optional): A list of post-processors to be applied to the model output and before returning the result. Defaults to [StripPostProcessor()].
...
def dictionary(context: str, 
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of example content to be mapped. Defaults to MapContent().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
...
def listing(condition: str,
    ...
    Args:
        ...
        default (str, optional): The default value to be returned if the task cannot be solved. Defaults to None. Alternatively, one can implement the decorated function.
        examples (List[str], optional): A list of examples that can be used to validate the output of the model. Defaults to ListObjects().
        constraints (List[Callable], optional): A list of constrains applied to the model output to verify the output. Defaults to [].
        pre_processor (List[PreProcessor], optional): A list of pre-processors to be applied to the input and shape the input to the model. Defaults to None.
        post_processor (List[PostProcessor], optional): A list of post-processors to be applied to the model output and before returning the result. Defaults to [StripPostProcessor()].
