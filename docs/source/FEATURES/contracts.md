...
<img src="https://raw.githubusercontent.com/ExtensityAI/symbolicai/dev/artifacts/images/contract_flow.png" width="400px" style="cursor: pointer;" onclick="this.style.width = this.style.width === '400px' ? '720px' : '400px';" title="Click to expand/collapse">
</div>
