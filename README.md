...
* We focus on cognitive science and cognitive architectures research, and thus, our framework shouldn't be regarded as another LLM. We believe that the current state of the art in LLMs is not yet ready for general-purpose tasks. So, we concentrate on advances in concept learning, reasoning, and flow control of the generative process.
