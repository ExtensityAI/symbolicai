...
_MODIFY_EXAMPLES = ("text 'The quick brown fox jumps over the lazy dog.' modify 'fox to hours' =>The quick brown "
 ...
 'env:\n'
 '  PYTHONPATH: .')
_MAP_EXAMPLES = ("text '['apple', 'banana', 'kiwi', 'cat']' all fruits should become dogs =>['dog', 'dog', 'dog', "
 "'cat']",
...
_FORMAT_EXAMPLES = ("text 1 format 'number to text' =>one",
 ...
 "=>すみません、皆さん。でも、今日は参加できません。text 'Sorry, everyone. But I will not be able to join today.' format "
 "'japanese romanji' =>Sumimasen, minasan. Demo, kyō wa sanka dekimasen.text 'April 1, 2020' "
 "format 'EU date' =>01.04.2020",
 ...
 'env:\n'
 '  PYTHONPATH: .')
_REPLACE_EXAMPLES = ("text 'a + b' replace 'b' with '' =>a",
...
_INCLUDE_EXAMPLES = ("text 'The green fox jumps of the brown chair.' include 'in the living room' =>In the living room "
...
_EXTRACT_EXAMPLES = ("from 'My name is Ashly Johnson. Nice to meet you!' extract 'Full Name' =>Ashly Johnson",
