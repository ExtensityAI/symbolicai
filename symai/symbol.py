...
from typing import Any, Dict, List, Optional, Tuple, Callable, Type, Iterator, Union
...
class Symbol(ABC):
    ...
    def equals(self, string: str, context: str = 'contextually', **kwargs) -> 'Symbol':
        ...
        return Symbol(_func(self, string))
    ...
    def expression(self, expr: Optional[str] = None, expression_engine: str = None, **kwargs) -> 'Symbol':
        ...
        Args:
            ...
            expression_engine (Optional[str]): The expression engine to use for evaluation. Defaults to None.
    ...
    def replace(self, old: str, new: str, **kwargs) -> 'Symbol':
        ...
        return Symbol(_func(self, old, new))
    ...
    def rank(self, measure: Optional[str] = 'alphanumeric', order: Optional[str] = 'desc', **kwargs) -> 'Symbol':
        ...
        return Symbol(_func(self, measure))
    ...
    def extract(self, pattern: str, **kwargs) -> 'Symbol':
        ...
        return Symbol(_func(self, pattern))
    ...
    def expand(self, *args, **kwargs) -> 'Symbol':
        ...
        _tmp_llm_func = Symbol(_func(self, *args))
    ...
    def save(self, path: str, replace: Optional[bool] = False, serialize: Optional[bool] = True) -> 'Symbol':
        '''
