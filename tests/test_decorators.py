...
class TestDecorator(unittest.TestCase):
    ...
    def test_replace(self):
        demo = Demo('Rick M. McConnell is the CEO of Dynatrace.')
        res = demo.replace_substring('McConnell Rick', 'Bernd Greifeneder')
        self.assertTrue('Bernd' in res)
    ...
    def test_notify_subscriber(self):
        demo = Demo()
        res = demo.notify_subscriber('You can contact us via email at office@dynatrace.com.', 
