...
""")
    ...
    def test_graph_component(self):
        ...
        data = """Theoretical linguistics is a branch of linguistics which inquires into the nature of language. It covers areas such as syntax, morphology, phonology, semantics, and the syntax-semantics interface. Applied linguistics covers fields such as language acquisition, anthropological linguistics, and language application.', 'Theoretical linguistics is a term in linguistics which, like the related term general linguistics, can be understood in different ways. Both can be taken as a reference to theory of language, or the branch of linguistics which inquires into the nature of language and seeks to answer fundamental questions as to what language is, or what the common ground of all languages is. The goal of theoretical linguistics can also be the construction of a general theoretical framework for the description of language.\nAnother use of the term depends on the organisation of linguistics into different sub-fields. The term theoretical linguistics is commonly juxtaposed with applied linguistics. This perspective implies that the aspiring language professional, e.g. a teacher student, must first learn the theory i.e. properties of the linguistic system, or what Ferdinand de Saussure called internal linguistics. This is followed by practice, or studies in the applied field. The dichotomy is not fully unproblematic because language pedagogy, language teaching, and language acquisition are all closely related.\nTheoretical frameworks include formalist, glossematics, constituency, dependency, distributionalism, generative, functional, Prague school, functional discourse grammar, cognitive, usage-based, systemic functional, structuralism.\nTopics include autonomy of syntax, compositionality, conservative/innovative forms, descriptivism, etymology, iconicity, internet linguistics, LGBT linguistics, origin of language, orthography, philosophy of linguistics, prescriptivism, second-language acquisition, theory of language.', "When the concept of theoretical linguistics is taken as referring to core or internal linguistics, it means the study of the parts of the language system. This traditionally means phonology, morphology, syntax and semantics. Pragmatics and discourse can also be included; delimitation varies between institutions. Furthermore, Saussure's definition of general linguistics consists of the dichotomy of synchronic and diachronic linguistics, thus including historical linguistics as a core issue. Linguistic theories include various frameworks of generative grammar and cognitive linguistics. See also: Theory of language, Theoretical Linguistics – journal, Course in General Linguistics, and References.", 'Raffi, Giorgio (2009). "20th century linguistics: overview of trends". Concise Encyclopedia of Philosophy of Language and Linguistics. Elsevier. pp. 780–794. ISBN 9780080965017.\n\nJump up to: a b Harris, Tony (2001). "Linguistics in applied linguistics: a historical overview". Journal of English Studies. 3 (2): 99–114. doi:10.18172/jes.72. Retrieved 2020-08-03.\n\nJump up to: a b de Saussure, Ferdinand (1959) [First published 1916]. Course in General Linguistics (PDF). New York: Philosophy Library. ISBN 9780231157278. Archived from the original (PDF) on 2019-08-08. Retrieved 2020-08-03.\n\n"General linguistics". University of Helsinki. 2020. Retrieved 2020-08-03.\n\nPortals: Language Linguistics\n\nThis page was last edited on 17 December 2022, at 15:50 (UTC)."""
